...
#include "lcd.h"
 MX_GPIO_Init();
  ...
  Lcd_cursor(&lcd, 1,0);
  Lcd_string(&lcd,"KAVINESH");

```
## Output screen shots of proteus  :
![exp4out](https://github.com/kavinesh8476/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/118466561/dfff195b-db80-481d-84ea-2d5ff1382a84)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![image](https://github.com/kavinesh8476/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/118466561/b1889f96-5f8c-4cfd-8a67-3d305de605e0)
